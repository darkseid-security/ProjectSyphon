    ...
    try:
        ...
        for index,data in enumerate(cursor.fetchall()):
            ...
            for index,data in enumerate(cursor.fetchall()):
                ...
                csv_writer.writerow([full_name,company_name,street_address,city,state,zipcode,country_code,email,phone_number,date_of_birth_day,date_of_birth_month,date_of_birth_year])
